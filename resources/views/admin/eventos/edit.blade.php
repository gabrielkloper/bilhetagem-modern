...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('admin.eventos.update', $evento) }}" method="POST" id="evento-form">
                @csrf
                @method('PUT')
                    ...
                    <div id="tab-dados" class="tab-content">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="titulo" id="titulo" value="{{ old('titulo', $evento->titulo) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('titulo') border-red-300 @enderror" required>
                                @error('titulo')
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="descricao" id="descricao" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('descricao') border-red-300 @enderror">{{ old('descricao', $evento->descricao) }}</textarea>
                                @error('descricao')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="local" id="local" value="{{ old('local', $evento->local) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('local') border-red-300 @enderror" required>
                                @error('local')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="cidade" id="cidade" value="{{ old('cidade', $evento->cidade) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('cidade') border-red-300 @enderror" required>
                                @error('cidade')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="endereco" id="endereco" value="{{ old('endereco', $evento->endereco) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('endereco') border-red-300 @enderror">
                                @error('endereco')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="data_inicio" id="data_inicio" value="{{ old('data_inicio', $evento->data_inicio?->format('Y-m-d')) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('data_inicio') border-red-300 @enderror" required>
                                @error('data_inicio')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="data_fim" id="data_fim" value="{{ old('data_fim', $evento->data_fim?->format('Y-m-d')) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('data_fim') border-red-300 @enderror" required>
                                @error('data_fim')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="hora_inicio" id="hora_inicio" value="{{ old('hora_inicio', substr($evento->hora_inicio, 0, -3), $evento->hora_inicio) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('hora_inicio') border-red-300 @enderror">
                                @error('hora_inicio')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="hora_fim" id="hora_fim" value="{{ old('hora_fim', substr($evento->hora_fim, 0, -3), $evento->hora_fim) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('hora_fim') border-red-300 @enderror">
                                @error('hora_fim')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="capacidade" id="capacidade" value="{{ old('capacidade', $evento->capacidade) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('capacidade') border-red-300 @enderror" required>
                                @error('capacidade')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    @php
                                        $precoFormatado = $evento->preco_padrao ? number_format($evento->preco_padrao, 2, ',', '.') : '';
                                    @endphp
                                    <input type="text" name="preco_padrao" id="preco_padrao" value="{{ old('preco_padrao', $precoFormatado) }}" class="pl-8 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('preco_padrao') border-red-300 @enderror">
                                </div>
                                @error('preco_padrao')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="idade_minima" id="idade_minima" value="{{ old('idade_minima', $evento->idade_minima) }}" min="0" max="150" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('idade_minima') border-red-300 @enderror">
                                @error('idade_minima')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="idade_maxima" id="idade_maxima" value="{{ old('idade_maxima', $evento->idade_maxima) }}" min="0" max="150" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('idade_maxima') border-red-300 @enderror">
                                @error('idade_maxima')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <p class="mt-1 text-xs text-gray-500">Deixe vazio para não restringir</p>
                            ...
                            <div>
                                ...
                                <select name="status" id="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('status') border-red-300 @enderror" required>
                                    ...
                                    <option value="finalizado" {{ old('status', $evento->status) == 'finalizado' ? 'selected' : '' }}>Finalizado</option>
                                </select>
                                @error('status')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                ...
                                <fieldset>
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex items-center">
                                            <input id="ativo" name="ativo" type="checkbox" value="1" {{ old('ativo', $evento->ativo) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                            <label for="ativo" class="ml-2 text-sm text-gray-700">Evento ativo</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="publico" name="publico" type="checkbox" value="1" {{ old('publico', $evento->publico) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                            <label for="publico" class="ml-2 text-sm text-gray-700">Evento público</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="permite_prevenda" name="permite_prevenda" type="checkbox" value="1" {{ old('permite_prevenda', $evento->permite_prevenda) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                            ...
                            <div class="md:col-span-2">
                                <fieldset>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div class="flex items-center">
                                            <input id="aceita_dinheiro" name="aceita_dinheiro" type="checkbox" value="1" {{ old('aceita_dinheiro', $evento->aceita_dinheiro) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                        ...
                                        <div class="flex items-center">
                                            <input id="aceita_cartao" name="aceita_cartao" type="checkbox" value="1" {{ old('aceita_cartao', $evento->aceita_cartao) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                        ...
                                        <div class="flex items-center">
                                            <input id="aceita_pix" name="aceita_pix" type="checkbox" value="1" {{ old('aceita_pix', $evento->aceita_pix) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                        ...
                                        <div class="flex items-center">
                                            <input id="aceita_gratuito" name="aceita_gratuito" type="checkbox" value="1" {{ old('aceita_gratuito', $evento->aceita_gratuito) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="timezone" id="timezone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('timezone') border-red-300 @enderror">
                                    <option value="America/Sao_Paulo" {{ old('timezone', $evento->timezone ?? 'America/Sao_Paulo') == 'America/Sao_Paulo' ? 'selected' : '' }}>São Paulo (UTC-3)</option>
                                    <option value="America/Manaus" {{ old('timezone', $evento->timezone) == 'America/Manaus' ? 'selected' : '' }}>Manaus (UTC-4)</option>
                                    <option value="America/Rio_Branco" {{ old('timezone', $evento->timezone) == 'America/Rio_Branco' ? 'selected' : '' }}>Rio Branco (UTC-5)</option>
                                </select>
                                @error('timezone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="tempo_atualiza" id="tempo_atualiza" value="{{ old('tempo_atualiza', $evento->tempo_atualiza ?? 10) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('tempo_atualiza') border-red-300 @enderror">
                            ...
                            <div>
                                ...
                                <input type="number" name="tempo_tela" id="tempo_tela" value="{{ old('tempo_tela', $evento->tempo_tela ?? 3600) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('tempo_tela') border-red-300 @enderror">
                                @error('tempo_tela')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <fieldset>
                                    ...
                                    <div class="flex items-center">
                                        <input id="mostra_tempo" name="mostra_tempo" type="checkbox" value="1" {{ old('mostra_tempo', $evento->mostra_tempo ?? true) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                    ...
                    <div id="tab-regras" class="tab-content hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="regras_home" id="regras_home" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('regras_home') border-red-300 @enderror" placeholder="Regras exibidas na página inicial...">{{ old('regras_home', $evento->regras_home) }}</textarea>
                                @error('regras_home')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="regras_cadastro" id="regras_cadastro" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('regras_cadastro') border-red-300 @enderror" placeholder="Regras do processo de cadastro...">{{ old('regras_cadastro', $evento->regras_cadastro) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="regras_parque" id="regras_parque" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('regras_parque') border-red-300 @enderror" placeholder="Regras gerais do evento...">{{ old('regras_parque', $evento->regras_parque) }}</textarea>
                                @error('regras_parque')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="observacoes" id="observacoes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('observacoes') border-red-300 @enderror" placeholder="Observações internas sobre o evento...">{{ old('observacoes', $evento->observacoes) }}</textarea>
                                @error('observacoes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-600">
                <div>
                    ...
                    <code class="text-xs bg-gray-100 px-1 py-0.5 rounded">{{ $evento->hash }}</code>
                </div>
                <div>
